    ...
    <div style="background: #f3f4f6; min-height: 100vh; padding: 32px 48px; font-family: 'Montserrat', sans-serif;">
        <div style="max-width: 1400px; margin: 0 auto;">
            ...
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 32px;">
                <div style="position: relative; border-radius: 12px; overflow: hidden; aspect-ratio: 3/2; cursor: pointer;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 32px;">
                <div style="background: #fce3cf; border-radius: 12px; padding: 40px; display: flex; flex-direction: column; justify-content: center;">
            ...
            <div style="position: relative; border-radius: 12px; overflow: hidden; margin-bottom: 32px;">
            ...
            <div style="background: #fce3cf; border-radius: 12px; padding: 48px; text-align: center; margin-bottom: 32px;">
